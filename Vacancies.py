...
#Создаем класс вакансий и через API загружаем с HH информацию о вакансиях по установленным фильтрам
class Vacancies:
    ...
    # def load_file(self, vacancies_file):
...
#vacancy.load_vacancy_data('vacancies.json')
#print(len(vacancy.load_vacancy_data('vacancies.json')))
#print(company.load_file('employers.json'))

#vacancy.get_data_vacancies()
#print(len(vacancy.get_data_vacancies()))
#print(len(vacancy.get_data_vacancies()['items']))